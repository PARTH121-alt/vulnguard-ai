...
const MODELS = [
  ...
  },
  {
    ...
    pros: ['Analyzes 80+ code features', 'CWE-aware detection', 'Structural + semantic analysis'],
    cons: ['Feature-engineering based', 'Not transformer-based yet'],
    note: 'Uses code-aware feature extraction inspired by CodeBERT. Analyzes token patterns, structural complexity, and CWE indicators.',
  },
  {
    id: 'ensemble',
    name: 'Ensemble',
