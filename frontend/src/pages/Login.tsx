    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      ...
      <div className="w-full max-w-md relative">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm mt-1">Sign in to access your security dashboard</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 text-slate-400">
                <input type="checkbox" className="rounded" style={{ accentColor: '#00d4ff' }} />
                Remember me
              </label>
              <Link to="/forgot-password" className="text-cyan-400 hover:text-cyan-300">Forgot password?</Link>
            </div>
